...
class Spacedmonkey_Theme {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( $this->get_theme_slug().'-style', get_stylesheet_uri(), array($this->get_theme_slug().'-fonts','genericons', 'twitter-bootstrap-theme'), filemtime(get_stylesheet_directory() . '/style.css') );
